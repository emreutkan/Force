...
export default function UpgradePrompt({
  ...
  const helperText =
    message || `${feature} is included with Pro. See what it adds and unlock it any time.`;
    ...
    return (
      <Pressable style={styles.compactCard} onPress={handleUpgrade}>
        ...
        <View style={styles.compactRight}>
          <Text style={styles.compactCta}>See plans</Text>
    ...
    <Pressable style={styles.card} onPress={handleUpgrade}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.textContainer}>
          <Text style={styles.eyebrow}>Available on Pro</Text>
